...
\begin{frame}{A Non-TSL Pattern: Sour Grapes Harmony}
    ...
    \begin{block}{Why Sour Grapes isn't TSL}
        \begin{itemize}
            \item All vowels \Purple{V} must be on the vowel harmony tier. 
            \item The blocker \Teal{B} must be on the same tier in order to block it.
            \item But there is no bound on the number of vowels per tier.
            \item The tier thus may have the shape
                %
                \begin{center}
                    $\cdots$ \Purple{V} \Purple{V} \Purple{V} $\cdots$ \Teal{B} $\cdots$
                \end{center}
                %
            \item \Teal{B} can be arbitrarily far away from \Purple{V}\Purple{V}\Purple{V} $\Rightarrow$ not a local relation
            \item But we need to know whether \Teal{B} is on the tier in order to determine the well-formedness of \Purple{V}\Purple{V}\Purple{V}.
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}{More Patterns Beyond TSL?}
    ...
    \begin{itemize}
        \item \textbf{Non-Final RHOL}\\
            \begin{itemize}
                \item discussed in \highlight{Hyunah Baek's talk}
                \item a minor extension of TSL suffices
            \end{itemize}
        \item \textbf{Multiple Harmony}\\
            \begin{itemize}
                \item discussed in \highlight{Al\"{e}na Aks\"{e}nova's talk}
        ...
        \item TSL avoids instances of OT overgeneration:
            \begin{itemize}
                ...
                \item explains why consonant harmony is unbounded or transvocalic,\\
                    ...
                    \citecolor{\citep{McMullinHansson15}}
            \end{itemize}
    \end{itemize}
\end{frame}
